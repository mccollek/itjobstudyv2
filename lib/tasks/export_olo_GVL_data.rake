...
desc "Export IT-oLogy Greenville Data"
task :export_olo_GVL_data => [:environment] do
  data_file = 'lib/data/wiggins/gvl_data.csv'
  CSV.open(data_file, "wb") do |row|
    OccupationalStatistic.where(area_id: [143,584],
