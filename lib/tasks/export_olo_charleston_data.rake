...
desc "Export IT-oLogy Charleston Data"
task :export_olo_charleston_data => [:environment] do
  data_file = 'lib/data/wiggins/charleston_data.csv'
  CSV.open(data_file, "wb") do |row|
    OccupationalStatistic.where(area_id: [59,584],
